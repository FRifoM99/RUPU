...
texto.write('Robot,Delta_muestra,Input_d,d_ref,vel_ref,Input_vel,Input_theta,Output_d,Output_vel,Output_theta,curv,vel_crucero,curv_pred,control'+'\n')
texto.close()
...
class App(customtkinter.CTk):
    ...
    def create_ip_entries(self):
        ...
        for i in range(num_entries):
            ...
            ip_entry.insert(customtkinter.END,'192.168.0.10')
