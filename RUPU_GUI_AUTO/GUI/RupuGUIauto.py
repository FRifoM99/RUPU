#RupuControlerV7 GUI version Modo Automatico
...
class App(customtkinter.CTk):
    ...
    def layout(self):
        ...
        self.from_auto = False # Etiqueta para invertir la secuencia si viene de modo automatico 
    ...
    def clickStopButton(self):
        self._fix_order_if_auto()
        print(self.ip_entry_widgets[0][0].get())
        UDP_IP_TX = self.ip_entry_widgets[0][0].get()
        UDP_PORT_TX = 1111
    ...
    def _fix_order_if_auto(self):
        if self.from_auto:
            self.ip_entry_widgets.reverse()
            self.from_auto = False  # para no volver a invertir nunca más
