...
constexpr char MONITOR_IP[]     = "192.168.1.21"; // IP del dispositivo que supervisa los datos
...
void loop(){
  ...
  else if(estado==inicio && parar.equals("si")){
    estado_siguiente=inicio;
    Serial.print(" inicio1");
  }
  else if(estado==inicio && parar.equals("no")){
  ...
  else if(estado==controlLoop && parar.equals("no")){
    estado_siguiente=controlLoop;
    Serial.print(" control loop 2");
  }
  else if(estado==controlLoop && parar.equals("si")){
    estado_siguiente=inicio;
